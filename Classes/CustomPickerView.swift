...
class CustomPickerView: UIView {
    ...
    let detail1: UIView = {
        ...
        detail1.backgroundColor = UIColor(named: Constants.accentDark)
        detail1.alpha = 1
        detail1.layer.cornerRadius = Constants.cornerRadiusSmall
        return detail1
    }()
    ...
    let detail2: UIView = {
        ...
        detail2.backgroundColor = UIColor(named: Constants.accentDark)
        detail2.alpha = 1
        detail2.layer.cornerRadius = Constants.cornerRadiusSmall
        return detail2
    }()
    ...
    let detail3: UIView = {
        ...
        detail3.backgroundColor = UIColor(named: Constants.accentDark)
        detail3.alpha = 1
        detail3.layer.cornerRadius = Constants.cornerRadiusSmall
        return detail3
    }()
    ...
    let unitLabel: UILabel = {
        ...
        unitLabel.textColor = UIColor(named: Constants.lightText)
        return unitLabel
    }()
